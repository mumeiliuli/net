...
EOT;
                ...
                break;
            default:
                $script = "var editor;KindEditor.ready(function(K) {
	editor=K.create('#" . $this->id . "', " . $clientOptions . ");
	editor.afterChange=function(){editorChange(editor);};
	editor.afterFocus=function(){editorChange(editor);};
	editor.afterBlur=function(){editorChange(editor);};
});";
                break;
        }
